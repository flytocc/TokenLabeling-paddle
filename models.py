...
from util.layers import DropPath, to_2tuple, constant_, zeros_, trunc_normal_
...
class Attention(nn.Layer):
    ...
    def forward(self, x):
        ...
        qkv = self.qkv(x).reshape(
            [-1, N, 3, self.num_heads, C // self.num_heads]).transpose([2, 0, 3, 1, 4])
...
class PatchEmbed4_2(nn.Layer):
    ...
    def __init__(self,
        ...
        self.conv1 = nn.Conv2D(in_chans, 64, 7, stride=2,
...
class LV_ViT(nn.Layer):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes=1000, embed_dim=768, depth=12,
                 ...
                 p_emb='4_2', skip_lam=1.0, mix_token=False, return_dense=False):
        super().__init__()
